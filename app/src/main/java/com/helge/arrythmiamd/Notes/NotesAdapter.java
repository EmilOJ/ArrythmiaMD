...
import com.helge.arrythmiamd.ArrythmiaMDApplication;
...
public class NotesAdapter extends ParseQueryAdapter<ParseObject> {
    ...
    public NotesAdapter(Context context) {
        super(context, new ParseQueryAdapter.QueryFactory<ParseObject>() {
            public ParseQuery create() {
                ...
                query.whereEqualTo("patientCPR", ArrythmiaMDApplication.gCurrent_patient.getString("CPR"));
                return query;
            }
        });
    ...
    // Set and inflate each item on the list and set custom text (Timestamp and content snippet)
    @Override
